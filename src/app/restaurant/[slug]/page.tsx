    ...
    <div className="min-h-screen bg-slate-950 text-slate-200">
      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-12 py-24">
        <Link 
          ...
          className="inline-flex items-center gap-2 text-slate-400 hover:text-amber-500 transition-colors mb-8 font-medium"
        >
          <ArrowLeft className="w-4 h-4" /> Back to Top 10 List
        </Link>

        {/* Hero Section */}
        <header className="bg-slate-900/80 border border-slate-800 rounded-3xl p-8 sm:p-12 mb-12 shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-amber-500/10 blur-[80px] rounded-full pointer-events-none" />
          
          <div className="relative z-10">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-600 mb-6">
              {restaurant.name}
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 border-t border-slate-800 pt-8">
              ...
              <div className="flex items-center gap-3 text-slate-400">
                ...
                <a href={`tel:${restaurant.phone.replace(/[^0-9]/g, '')}`} className="text-sm font-medium hover:text-amber-400 transition-colors">
                  {restaurant.phone}
                </a>
              </div>
              {restaurant.website && (
        ...
        {/* SEO Article Content */}
        <article className="prose prose-invert prose-amber max-w-none mb-12 lg:prose-lg">
