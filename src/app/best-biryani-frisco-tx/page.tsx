    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 selection:bg-amber-500/30">
      ...
      <section className="relative pt-32 pb-20 px-6 sm:px-12 lg:px-24 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h1 className="text-4xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-600 mb-6 leading-tight">
      ...
      <section className="px-6 sm:px-12 lg:px-24 pb-32">
        <div className="max-w-4xl mx-auto space-y-12">
          {top10.map((restaurant, index) => (
            <article 
              key={restaurant.id} 
              className="bg-slate-900/50 border border-slate-800 rounded-3xl p-6 md:p-8 flex flex-col md:flex-row gap-8 hover:bg-slate-900 transition-colors group"
            >
              <div className="flex-shrink-0 flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 text-slate-950 font-black text-2xl shadow-lg shadow-amber-500/20">
                #{index + 1}
              </div>
              
              <div className="flex-1">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                  <h2 className="text-2xl md:text-3xl font-bold text-white group-hover:text-amber-400 transition-colors">
                    {restaurant.name}
                  </h2>
                ...
                <div className="pt-6 border-t border-slate-800 flex justify-end">
                  <Link 
                    ...
                    className="inline-flex items-center gap-2 text-amber-500 font-bold hover:text-amber-400 transition-colors group/link"
                  >
      ...
      {/* SEO Footer Text */}
      <section className="bg-slate-900 border-t border-slate-800 py-16 px-6 sm:px-12 lg:px-24">
        <div className="max-w-4xl mx-auto prose prose-invert prose-amber">
          <h2>Why Frisco is the Biryani Capital of Texas</h2>
          <p>
